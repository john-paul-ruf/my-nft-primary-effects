...
export class ChladniPlateConfig extends EffectConfig {
    constructor({
                    invertLayers = true,
                    layerOpacity = 0.7,
                    ...
                    stroke = 1,
                    thickness = 2,
                    plateRadius = new PercentageRange(new PercentageShortestSide(0.2), new PercentageShortestSide(0.45)),
                    resolution = new Range(30, 60),
                    modeM = new Range(1, 6),
                    modeN = new Range(1, 6),
                    morphSpeed = new Range(1, 3),
                    nodalThreshold = new Range(1, 3),
                    speed = new Range(1, 2),
        ...
        this.nodalThreshold = nodalThreshold;
        this.speed = speed;
